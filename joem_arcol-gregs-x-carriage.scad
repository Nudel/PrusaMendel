	...
	difference()
	{
		union ()
		{
			...
			barbell (
				...
				[25,-holder_separation/2],
				lm8uu_holder_width/2,lm8uu_holder_width/2,25,12);
			...
			*polygon(points=[
				...
				[25-lm8uu_holder_width/2, holder_separation/2+lm8uu_holder_length],
				[-1*(25-lm8uu_holder_width/2), holder_separation/2+lm8uu_holder_length],
				[-1*(25-lm8uu_holder_width/2), -1*(holder_separation/2+lm8uu_holder_length)],
				[25-lm8uu_holder_width/2, -1*(holder_separation/2+lm8uu_holder_length)]],
				paths=[[3,2,1,0]]);
			...
			translate([-25 - lm8uu_holder_width/2,-(holder_separation/2+lm8uu_holder_length),0])
			cube([50 + lm8uu_holder_width/2,  (holder_separation/2+lm8uu_holder_length) * 2,lm8uu_support_thickness]);
			...
			for (i=[-1,1])
			translate([-25-13.5-1,i*(lm8uu_holder_length/2+belt_clamp_width/2)/2])
			rotate(90*(i+1)+180) 
			belt_clamp_socket ();
		}
